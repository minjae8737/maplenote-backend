...
public class CharacterAbility {
    ...
    private AbilityPreset abilityPreset1;  // 어빌리티 1번 프리셋 전체 정보

    @JsonProperty("ability_preset_2")
    private AbilityPreset abilityPreset2;  // 어빌리티 2번 프리셋 전체 정보

    @JsonProperty("ability_preset_3")
    private AbilityPreset abilityPreset3;  // 어빌리티 3번 프리셋 전체 정보
