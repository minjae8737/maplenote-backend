...
public class PetAutoSkill {
    ...
    private String skill1; // 첫 번째 슬롯에 등록된 자동 스킬

    @JsonProperty("skill_1_icon")
    private String skill1Icon; // 첫 번째 슬롯에 등록된 자동 스킬 아이콘

    @JsonProperty("skill_2")
    private String skill2; // 두 번째 슬롯에 등록된 자동 스킬

    @JsonProperty("skill_2_icon")
    private String skill2Icon; // 두 번째 슬롯에 등록된 자동 스킬 아이콘
}